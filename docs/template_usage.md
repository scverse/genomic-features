...
Now that your new project repository has been created on github at `https://github.com/ivirshup/genomic-features` you can push your first commit to github.
...
git remote add origin https://github.com/ivirshup/genomic-features.git
...
The workflows should now succeed and you will be able to find the code coverage at this link: `https://app.codecov.io/gh/ivirshup/genomic-features`. You might have to wait couple of minutes and the coverage of this repository should be ~60%.
